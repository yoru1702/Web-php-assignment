    ...
    <div class="card-body">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-sm-12 col-12">
                    <a href="manage_confirm.php" class="btn w-100 m-2 bg-primary" type="button" style="color: #fff; "><b>ตัดรายการสินค้าออกคลัง</b></a>
                    <!-- <button class="btn w-100 m-2 bg-primary" type="button" style="color: #fff; "><b>เพิ่มการขายสินค้า</b></button> -->
                </div>
                <!-- <div class="col-lg-6 col-sm-6 col-12">
                    <button class="btn w-100 m-2 bg-" type="button" style="color: #fff; " onclick="cal_num7()">คลิก คำนวณราคา</button>
                </div> -->
            </div>
        </div>
    </div>
