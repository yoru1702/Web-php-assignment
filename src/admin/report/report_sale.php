                        ...
                        <?php while ($row = mysqli_fetch_assoc($res)): ?>
                            <tr>
                                ...
                                <td>
                                    <button 
                                        type="button"
                                        class="btn btn-outline-info btn-sm btn-view-receipt"
...
$(document).ready(function() {
    $(".btn-view-receipt").click(function() {
        ...
        $("#receiptContent").html(`
            <div class='modal-body text-center'>
                <i class="fa-solid fa-spinner fa-spin"></i> กำลังโหลดใบเสร็จ...
            </div>
        `);

        $.ajax({
            url: "/project_assignment/src/admin/report/viewReceipt.php",
            type: "GET",
            data: { sale_id: saleId },
