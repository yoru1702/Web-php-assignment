        ...
        <div class="modal-body">
            <div class="row g-3">
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="name_user" id="name_user" placeholder="กรอกชื่อพนักงาน" value="<?= $read['name_user']?>" required>
                </div>
                <div class="col-sm-3">
                    <label class="form-label">นามสกุล :</label>
                    <input type="text" step="0.01" class="form-control" name="sname_user" id="sname_user" placeholder="กรอกนามสกุลพนักงาน" value="<?= $read['sname_user']?>" required>
                </div>
                <div class="col-sm-3">
                    <label class="form-label">Username :</label>
                    <input type="text" class="form-control" name="username" id="username" placeholder="Username" value="<?= $read['username']?>" required>
                </div>
                <div class="col-sm-3">
